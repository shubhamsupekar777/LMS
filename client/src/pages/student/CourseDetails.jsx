  ...
  return courseData ? (
    ...
    <div className='flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left'>
      ...
      <div className='max-w-xl z-10 text-gray-500'>
        <h1 className='md:text-course-details-heading-large text-course-details-heading-small font-semibold text-gray-800 bold-lg text-xl font-semibold text-gray-800'>
        ...
        <div className='flex items-center space-x-2 pt-3 pb-1 text-sm'>
          ...
          <p>{courseData.enrolledStudents.length} student </p>
        </div>

        <p className='text-sm'>Course By <span className='text-blue-600 underline'>Shubham Supekar</span></p>
      ...
      {/* Right Column */}
      <div className='max-w-course-card
       z-10 shadow-custom-card-rounded-t
          ...
          <button className='md:mt-6 mt-4 w-full py-3 rounded bg-blue-600 text-white font-medium'>
             ...
             <div>
              ...
              <ul className='ml-4 pt-2 text-sm md:text-default list-disc text-gray-500'>
                ...
                <li>Downloaded resources and source code</li>
